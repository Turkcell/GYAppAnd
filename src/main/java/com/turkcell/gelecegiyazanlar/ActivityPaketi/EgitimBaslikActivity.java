...
import com.turkcell.gelecegiyazanlar.AdapterVeListenerPaketi.MyExpandableAdapter;
...
public class EgitimBaslikActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mint.initAndStartSession(EgitimBaslikActivity.this, "75ff8154");
    ...
    private void ActionbarTasarým(){
        ...
        if(renk.equals("android")){
            toolbar.setBackgroundColor(getResources().getColor(R.color.androidYesili));
        }else if(renk.equals("ios")){
            toolbar.setBackgroundColor(getResources().getColor(R.color.iosSiyahi));
        }else if(renk.equals("win")){
            toolbar.setBackgroundColor(getResources().getColor(R.color.windowsMavisi));
        }else if(renk.equals("web")){
            toolbar.setBackgroundColor(getResources().getColor(R.color.webRengi));
        }else if(renk.equals("app")){
            toolbar.setBackgroundColor(getResources().getColor(R.color.app_inventor_kirmizi));
        }else if(renk.equals("scratch")){
            toolbar.setBackgroundColor(getResources().getColor(R.color.scratch_turuncu));
        }
        else if(renk.equals("arduino")){
            toolbar.setBackgroundColor(getResources().getColor(R.color.arduino));
        }
    }
