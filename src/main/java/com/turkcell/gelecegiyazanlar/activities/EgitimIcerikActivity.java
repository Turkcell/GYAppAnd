...
public class EgitimIcerikActivity extends ActionBarActivity {
                ...
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            CurioClient.getInstance(getApplicationContext()).sendEvent("Egitim İçerik>" + dugumBaslik, title);
    ...
    protected void onStop() {
        super.onStop();
        CurioClient.getInstance(getApplicationContext()).endEvent("Egitim İçerik>" + dugumBaslik, title, System.currentTimeMillis() - time);
