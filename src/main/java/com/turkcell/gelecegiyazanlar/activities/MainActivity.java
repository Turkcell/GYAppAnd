...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * liste itemlar�na t�klanma ve ge�i� i�in kullan�lan k�s�m.
         */
    ...
    protected void onStart() {
        CurioClient.getInstance(getApplicationContext()).startScreen(MainActivity.this, "Eğitimler", "sample");
